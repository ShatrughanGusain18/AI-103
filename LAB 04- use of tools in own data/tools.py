...
def main():
    ...
    try:
        ...
        # Load PDF files
        file_streams = [
            open(f, "rb") for f in glob.glob("brochures/*.pdf")
        ]
...
Answer questions about services offered by Margie's Travel using the
provided travel brochures.

Search the web for general information about destinations or current
travel advice.
                """,
                input=input_text,
